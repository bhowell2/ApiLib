...
public class ApiParamBuilder<ParamType, ParamsObj> {
	 ...
	 * @param <ParamsObj> type of request parameters object (e.g., {@code Map<String, Object>})
	 * @return
	 */
	...
	protected List<FormatFunc<? extends Object, ParamType>> formatFuncs;
	...
	public ApiParamBuilder<ParamType, ParamsObj> addFormatFunction(FormatFunc<? extends Object, ParamType> formatFunc) {
		if (formatFunc == null) {
	...
	@SuppressWarnings("varargs")
	public ApiParamBuilder<ParamType, ParamsObj> addFormatFunctions(FormatFunc<? extends Object, ParamType>... formatFuncs) {
		// call addFormatFunction to avoid duplicate constraint code (e.g., checking for null)
		for (FormatFunc<? extends Object, ParamType> ff : formatFuncs) {
