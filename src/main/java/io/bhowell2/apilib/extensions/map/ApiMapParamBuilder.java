...
import static io.bhowell2.apilib.extensions.map.utils.ApiMapParamRetrievalFuncs.typeFromMap;
...
public class ApiMapParamBuilder<ParamType> extends ApiParamBuilder<ParamType, Map<String, Object>> {
	 ...
	 *
	 * @param paramName   name of parameter to retrieve from {@code Map<String, ?>}
	...
	public ApiMapParamBuilder<ParamType> addFormatFunction(FormatFunc<? extends Object, ParamType> formatFunc) {
		super.addFormatFunction(formatFunc);
		return this;
	}

	public ApiMapParamBuilder<ParamType> addFormatFunctions(FormatFunc<? extends Object, ParamType>... formatFuncs) {
