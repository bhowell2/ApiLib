...
public final class ApiParamCheck {
	...
	public static ApiParamCheck formatFailure(String parameterName, String message) {
		return new ApiParamCheck(new ParamError(ErrorType.FORMAT_ERROR, message, parameterName));
	}
